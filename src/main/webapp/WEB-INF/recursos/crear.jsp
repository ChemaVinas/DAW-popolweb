                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <i class="fa fa-upload fa-fw"></i> Subir recurso
                                </div>


                                <form:form id="creaRecu" method="POST" modelAttribute="recurso" cssClass="well form-horizontal">
                                    <fieldset>

                                        <!-- Form Name -->
                                        <legend>Sube tu recurso a Popol web</legend>
                                        <form:errors path="recurso.*" cssClass="error" element="div" />
                                        <!-- Text input-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 inputGroupContainer">
                                                ...
                                                <form:errors cssClass="label label-warning" path="tipo"/>
                                            ...
                                            <div class="col-md-4 inputGroupContainer">
                                                <div class="input-group">
                                                    <div class="btn-group" data-toggle="buttons">
                                                        <form:label path="privacidad" class="btn btn-primary active">
                                                            <form:radiobutton path="privacidad" value="false" id="option1" autocomplete="off" checked="true"/> Público
                                                        </form:label>
